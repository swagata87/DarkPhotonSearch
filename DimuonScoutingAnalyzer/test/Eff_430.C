...
int Eff_430() {
  ...
  TH1F* den1 = (TH1F*)file_in->Get("demo/histoDir/dimuMass_Den_430");
  TH1F* num1 = (TH1F*)file_in->Get("demo/histoDir/dimuMass_Num_430");
  TH1F* den1_pt1 = (TH1F*)file_in->Get("demo/histoDir/mu1_pt_Den_430");
  TH1F* num1_pt1 = (TH1F*)file_in->Get("demo/histoDir/mu1_pt_Num_430");
  TH1F* den1_pt2 = (TH1F*)file_in->Get("demo/histoDir/mu2_pt_Den_430");
  TH1F* num1_pt2 = (TH1F*)file_in->Get("demo/histoDir/mu2_pt_Num_430");
  ...
  TLatex* CMS_text_3 = new TLatex(0.20,0.53,"w.r.t HLT_PFHT430");
  CMS_text_3->SetNDC();
  ...
  canvas_eff1->Write();
  canvas_eff1->Print("eff1_430.pdf");

  canvas_eff2->Write();
  canvas_eff2->Print("eff2_430.pdf");

  canvas_eff3->Write();
  canvas_eff3->Print("eff3_430.pdf");

  canvas_eff4->Write();
  canvas_eff4->Print("eff4_430.pdf");
